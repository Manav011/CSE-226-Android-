...
class CustomListViewArrayAdapterExample : AppCompatActivity(){ // ArrayAdapter has less customization one thing that we can notice this through is less overridden method will be there
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        listView.setOnItemClickListener{ parent: AdapterView<*>, view: View, position: Int, id: Long ->
            if (position == 0) {
                ...
                startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("whatsapp://send?phone=+919782604033")))
            }
            else if (position == 4) {
